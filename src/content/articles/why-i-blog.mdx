...
excerpt: "It's been a while since I mentioned why I am blogging here, and I wanted to create a dedicated post for it since Robert has started a new list about why people blog"
status: finished
type: article
tags: ["no-topic"]
...
It's been a while since I <Link type="article" href="on-starting-a-blog">mentioned</Link> why I am blogging here, and I wanted to create a dedicated post for it since [Robert](https://birming.com/why-we-blog/) has started a new list about why people blog. Therefore, I want to have a list of reasons why I am blogging:

## 01 to design something I love to look at
...
## 02 getting better at writing and explaining stuff
