...
Anyway, below is the code where I use the [rexiv2](https://docs.rs/rexiv2/latest/rexiv2) crate to generate the necessary files with the required EXIF data inside them in a formatted manner.
