document.addEventListener('DOMContentLoaded', () => {
  ...
  menubar.addEventListener('click', () => {
    ...
    if (menubarExt.style.display === 'none' || menubarExt.style.display === '') {
  ...
  menubarSecond.addEventListener('click', () => {
    // Toggle the display of the menu
    if (menubarExtExt.style.display === 'none' || menubarExtExt.style.display === '') {
  ...
  document.addEventListener('click', (event) => {
    if (!menubarSecond.contains(event.target) && !menubarExtExt.contains(event.target)) {
      menubarExtExt.style.display = 'none';
    }
  });
